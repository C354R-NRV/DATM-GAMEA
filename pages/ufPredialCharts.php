...
<!-- 
    TOTAL PUNTOS PROGRAMADOS - TOTAL PUNTOS FISCALIZADOS - TOTAL PUNTOS PROCESADOS
    torta: conteo general -> cuantos puntos fueron creados, cuantos ya fueron UTILIZADOS, cuantos de ellos estan PROCESADOS y cuantos en DESACATO
    barra vertical -> agrupacion de puntos VISITADOS por operativo
    barra vertical -> agrupacion de puntos PROCESDOS Y/O en DESACATO por operativo
    barra horizontal -> cantidad de inmuebles fiscalizados agrupados por tipologia
