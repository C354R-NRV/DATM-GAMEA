        ...
        <div class="row position-relative">
            ...
            <div class="col-6" id="main-content">
                ...
                <div class="contenidoRecurso main-content-container" id="contenidoRecurso">
                    ...
                    <br>
                    <h2>"RESTRICCION ADMINISTRATIVA PARA LA EXTENSION DE LICENCIAS DE FUNCIONAMIENTO A ACTIVIDADES ECONOMICAS DE EXPENDIO, CONSUMO, COMERCIALIZACIN, ALMACEN, TRANSPORTE Y VENTA DE BEBIDAS ALCOHOLICAS EN EL MUNICIPIO DE EL ALTO"</h2>
                    <br>
                    <br>
