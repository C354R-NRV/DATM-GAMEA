...
(function ($) {
  ...
  $(window).scroll(function () {
    if ($(this).scrollTop() > 300) {
      ...
      $("#logodinamico_").html(
        '<img src="../img/gamea_.png" style="max-width: 3rem; padding-right: 1rem;"><img src="../img/logoDATM.png" style="max-width: 6rem;">'
      );
    } else {
      $(".sticky-top").removeClass("bg-primary shadow-sm").css("top", "-150px");
      $("#logodinamico_").html(
        '<img src="../img/gamea_.png" style="max-width: 3rem; padding-right: 1rem;"><img src="../img/SMAF_.png" style="max-width: 6rem;">'
      );
    }
  });
...
function showPromos() {
  ...
  /* par ahabilitar hasta conocer nueva linea grafica let dialog = bootbox.dialog({
    message: contenido,
    size: "large",
  }); */
}
