...
$cabeceraSolicitud->FechaEnvio   = $cabecera['fecha_envio_ansi'];
...
$cabeceraSolicitud->idSolicitud = $cabecera['id_cabecera_solicitud']; 
...
foreach ($items as $key => $item) {
    ...
    $itemSolicitud->TipoRespaldo = $item['id_tipo_respaldo'];
    $itemSolicitud->hashDetalle = $item['hash_detalle'];
...
/* $dat = json_encode($resp);
    echo $dat; 
*/
echo json_encode($cabeceraSolicitud, JSON_UNESCAPED_UNICODE);
echo "<hr>";
echo json_encode($itemsSolicitud_, JSON_UNESCAPED_UNICODE);
