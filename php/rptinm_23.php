    ...
    foreach ($resultados as $row) {
        ...
        $documento .= "
            ...
            <div style='margin:55px;'>
                ...
                <div style='text-align: right; margin-bottom: 20px;'>
                    <span style='text-decoration:underline;'><b>REF.: SOLICITUD DEL TRÁMITE DE BAJA POR CAMBIO DE JURISDICCIÓN DEL INMUEBLE CON REGISTRO TRIBUTARIO Nº  $numInmueble_</b></span>
                </div>
                <div style='text-align: justify;'>
                    <p>De mi mayor consideración:</p> 
                    <p>Por medio de la presente nota, me dirijo a su autoridad solicitando el trámite de BAJA POR CAMBIO DE JURISDICCIÓN del 
                    ...
                    <table class='tableReq' align='center'>
                        ...
                        <tr>
                            <td class='tableReqtd'>Comprobantes de pago del inmueble para baja (IMPBI).</td>
                            <td class='tableReqtd'></td>
                            <td class='tableReqtd'></td>
                        </tr>
                        <tr>
                            <td class='tableReqtd'>Certificado Jurisdiccional emitido por la Unidad de Límites territoriales. (Catastro GAMEA)</td>
                            <td class='tableReqtd'></td>
                            <td class='tableReqtd'></td>
                        </tr>
                        <tr>
