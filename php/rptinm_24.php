    ...
    foreach ($resultados as $row) {
        ...
        $documento .= "
            ...
            <div style='margin:55px;'>
                ...
                <div style='text-align: right; margin-bottom: 20px;'>
                    <span style='text-decoration:underline;'><b>REF.: SOLICITUD DEL TRAMITE DE BAJA POR DOBLE EMPADRONAMIENTO (MISMOS PROPIETARIOS) DEL INMUEBLE CON REGISTRO TRIBUTARIO Nº  $numInmueble_</b></span>
                </div>
                <div style='text-align: justify;'>
                    <p>De mi mayor consideración:</p> 
                    <p>Por medio de la presente nota, me dirijo a su autoridad solicitando el trámite de BAJA POR DOBLE EMPADRONAMIENTO (MISMOS PROPIETARIOS) del 
                    Inmueble con Registro Tributario Nº  <b> $numInmueble_</b> ($UBICACION_NIVEL2, $DIRECCION_DESCRIPTIVA, #$NUMERO_PUERTA), adjuntando 
                    a la presente la documentación necesaria que respalde la solicitud, todo ello al amparo de la Resolución Administrativa 
                    DRPT/Nº 006/2022 de fecha 02 de febrero de 2022.
                    </p>
                    <br>
                     ...
                     <table class='tableReq' align='center'>
                        ...
                        <tr>
                            <td class='tableReqtd'>Solicitud escrita de los propietarios (Dirigida al Director de Administración Tributaria Municipal).</td>
                            <td class='tableReqtd'></td>
                            <td class='tableReqtd'></td>
                        </tr>
                        <tr>
                            <td class='tableReqtd'>Testimonio de Propiedad (inmueble vigente).</td>
                            <td class='tableReqtd'></td>
                            <td class='tableReqtd'></td>
                        </tr>
                        <tr>
                            <td class='tableReqtd'>Tarjeta de Registro de Propiedad y/o Folio Real (inmueble vigente).</td>
                            <td class='tableReqtd'></td>
                            <td class='tableReqtd'></td>
                        </tr>
                        <tr>
                            <td class='tableReqtd'>Plano de lote (inmueble vigente).</td>
                            <td class='tableReqtd'></td>
                            <td class='tableReqtd'></td>
                        </tr>
                        <tr>
                            <td class='tableReqtd'>Plano de ubicación o croquis (detallado, inmueble vigente).</td>
                            <td class='tableReqtd'></td>
                            <td class='tableReqtd'></td>
                        </tr>
                        <tr>
                            <td class='tableReqtd'>Comprobantes de pago del inmueble vigente (IMPBI).</td>
                            <td class='tableReqtd'></td>
                            <td class='tableReqtd'></td>
                        </tr>
                        <tr>
