    ...
    $documento .= " 
        <page format='272x210' style='font: arial; color: #222222;'>
            <div style='margin:55px;'>
                ...
                <div style='text-align: right; margin-bottom: 20px;'>
                    <span style='text-decoration:underline;'><b>REF.: SOLICITUD DE EXENCION Y EXCLUSION DE IMPUESTOS</b></span>
                </div>
                <div style='text-align: justify;'> 

                    <p>Mediante la presente se solicita exención del Impuesto municipal a la propiedad de Vehículos Automotores Terrestres, $txtPlural:</p>

                    $detalleVehiculo
                    
                    <p>Correspondientes a las gestiones desde $gestionIni_ hasta $gestionFin_, lo cual se detalla en el documento.</p>
                    <p>No dudando de su gentil aceptación sin otro particular y agradeciendo de antemano a la presente solicitud, me despido con las consideraciones que amerita.</p>
                    <p>Atentamente,</p>
                    <p></p>
                    </div>
                </div>
