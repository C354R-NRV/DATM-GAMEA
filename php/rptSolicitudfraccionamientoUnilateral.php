    ...
    foreach ($resultados as $row) { 
        ...
        $documento .= "
            ...
            <div style='margin:55px;'>
                ...
                <div style='text-align: right; margin-bottom: 20px;'>
                    <span style='text-decoration:underline;'><b>REF.: SOLICITUD DE FRACCIONAMIENTO UNILATERAL DE INMUEBLES</b></span>
                </div>
                <div style='text-align: justify;'>
                    <p>Señor Director:</p> 
                    <p>Mediante la presente le hago llegar mis más sinceros saludos deseándoles éxitos en las labores que desempeña.</p> 
                    <p>El motivo de la misma es para SOLICITAR EL FRACCIONAMIENTO UNILATERAL del inmueble con número de registro tributario No. $numInmueble_. Con el objetivo de poder regularizar mis impuestos y cumplir con las obligaciones tributarias por el bien de nuestra ciudad.
                    </p>
                    <p>No dudando de su atención al presente y sin otro particular motivo saludo a usted con las consideraciones más distinguidas.</p>
                    <p>Atentamente,</p>
                    <p></p>
                    </div>
                </div>
