    ...
    foreach ($resultados as $row) {
        ...
        $documento .= "
            ...
            <div style='margin:55px;'>
                ...
                <div style='text-align: right; margin-bottom: 20px;'>
                    <span style='text-decoration:underline;'><b>REF.: SOLICITUD DEL TRAMITE DE EXENCIONES PERSONAS DE 60 AÑOS O MAS (TERCERA EDAD) DEL INMUEBLE CON REGISTRO TRIBUTARIO Nº $numInmueble_</b></span>
                </div>
                <div style='text-align: justify;'>
                    <p>De mi mayor consideración:</p> 
                    <p>Por medio de la presente nota, me dirijo a su autoridad solicitando el trámite de EXENCIONES PERSONAS DE 60 AÑOS O MAS (TERCERA EDAD)  del 
                    ...
                    <table class='tableReq' align='center'>
                        ...
                        <tr>
                            <td class='tableReqtd'>Certificado de vivencia actualizado (cuando corresponda)</td>
                            <td class='tableReqtd'></td>
                            <td class='tableReqtd'></td>
                        </tr>
                        <tr>
