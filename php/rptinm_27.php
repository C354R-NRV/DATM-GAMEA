    ...
    foreach ($resultados as $row) {
        ...
        $documento .= "
            ...
            <div style='margin:55px;'>
                ...
                <div style='text-align: right; margin-bottom: 20px;'>
                    <span style='text-decoration:underline;'><b>REF.: SOLICITUD DE DESBLOQUEO</b></span>
                </div>
                <div style='text-align: justify;'>
                    <p>Por intermedio de la presente le hago llegar un cordial saludo a su distinguida persona.</p> 
                    <p>Solicito muy respetuosamente instruya al area que corresponda, realizar el DESBLOQUEO del número de inmueble: <b> $numInmueble_</b> ($UBICACION_NIVEL2, $DIRECCION_DESCRIPTIVA, #$NUMERO_PUERTA), 
                    registrado a nombre de $nombre., adjuntando a la presente la documentación necesaria que respalde la solicitud, todo ello al amparo de la 
                    Resolución Administrativa DRPT/Nº 006/2022 de fecha 02 de febrero de 2022.</p>
