    ...
    foreach ($resultados as $row) {
        ...
        $documento .= "
            ...
            <div style='margin:55px;'>
                ...
                <div style='text-align: right; margin-bottom: 20px;'>
                    <span style='text-decoration:underline;'><b>REF.: SOLICITUD DEL TRAMITE DE PRESCRIPCIÓN DEL INMUEBLE CON REGISTRO TRIBUTARIO Nº $numInmueble_ DE LA GESTIÓN $gestion_ DE LA FACULTAD (determinación, imposición de sanción y/o ejecución)</b></span>
                </div>
                <div style='text-align: justify;'>
                    <p>De mi consideración.</p> 
                    <p>Mediante la presente tengo a bien dirigirme a su autoridad, deseándole los mejores éxitos y augurios en las funciones que desempeña a favor del municipio de El Alto</p> 
                    <p>Solicito muy respetuosamente la prescripción del número de inmueble: <b> $numInmueble_</b> ($UBICACION_NIVEL2, $DIRECCION_DESCRIPTIVA, #$NUMERO_PUERTA),  registrado a nombre de $nombre., de la gestión $gestion_, adjuntando a la presente la documentación necesaria que respalde la solicitud, todo ello al amparo de la Resolución Administrativa DRPT/Nº 006/2022 de fecha 02 de febrero de 2022.</p>
                    ...
                    <table class='tableReq' align='center'>
                        ...
                        <tr>
                            <td class='tableReqtd'>Solicitud escrita de él o los propietarios (Dirigida al Director de Administración Tributaria Municipal).</td>
                            <td class='tableReqtd'></td>
                            <td class='tableReqtd'></td>
                        </tr>
                        <tr>
                            <td class='tableReqtd'>Testimonio de Propiedad. (compra y venta)</td>
                            <td class='tableReqtd'></td>
                            <td class='tableReqtd'></td>
                        </tr>
                        <tr>
                            <td class='tableReqtd'>Folio Real y/o Tarjeta de Registro de Propiedad.</td>
                            <td class='tableReqtd'></td>
                            <td class='tableReqtd'></td>
                        </tr>
                        <tr>
                            <td class='tableReqtd'>Comprobante de pago del Impuesto (IMPBI).</td>
                            <td class='tableReqtd'></td>
                            <td class='tableReqtd'></td>
                        </tr>
                        <tr>
                    ...
                    <p>Sin otro particular y agradeciendo su atención, me despido de usted muy atentamente, esperando su pronta y positiva respuesta.</p>
                    <p>Atentamente,</p>
                    <p></p>
                    </div>
                </div>
