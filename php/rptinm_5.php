    ...
    foreach ($resultados as $row) {
        ...
        $documento .= "
            ...
            <div style='margin:55px;'>
                ...
                <div style='text-align: right; margin-bottom: 20px;'>
                    <span style='text-decoration:underline;'><b>REF.: SOLICITUD DEL TRAMITE DE EXCLUSIONES (INSTITUCIONES PÚBLICAS, MISIONES DIPLOMÁTICAS Y CONSULARES) DEL INMUEBLE CON REGISTRO TRIBUTARIO Nº $numInmueble_</b></span>
                </div>
                <div style='text-align: justify;'>
                    <p>De mi mayor consideración:</p> 
                    <p>Por medio de la presente nota, me dirijo a su autoridad solicitando el trámite de EXCLUSIONES (INSTITUCIONES PÚBLICAS, MISIONES DIPLOMÁTICAS Y CONSULARES) del 
                    ...
                    <table class='tableReq' align='center'>
                        ...
                        <tr>
                            <td class='tableReqtd'>Estados financieros, memoria anual y/o registros contables con desglose del inmueble.</td>
                            <td class='tableReqtd'></td>
                            <td class='tableReqtd'></td>
                        </tr>
                        <tr>
