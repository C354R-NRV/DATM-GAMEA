    ...
    foreach ($resultados as $row) {
        ...
        $documento .= "
            ...
            <div style='margin:35px 55px 55px 55px;'>
                ...
                <div style='text-align: right; margin-bottom: 20px;'>
                    <span style='text-decoration:underline;'><b>REF.: SOLICITUD DEL TRAMITE PARA LA BAJA POR OBSOLESCENCIA DEL VEHÍCULO  CON PLACA DE CONTROL N.º $num_placa_ (PARRAFO I CONFORME R.A. 020).</b></span>
                </div>
                <div style='text-align: justify;'>
                    ...
                    <table class='tableReq' align='center'>
                        ...
                        <tr>
                            <td class='tableReqtd'style='width: 550px;'>Documento de identidad del propietario o los propietarios (fotocopia y original), o Poder Notariado y documento de identidad del apoderado según corresponda.</td>
                            <td class='tableReqtd'></td>
                            <td class='tableReqtd'></td>
                        </tr>
                        <tr>
                            <td class='tableReqtd'style='width: 550px;'>Declaratoria de herederos o cualquier otro documento que acredite el interés legal del solicitante, si corresponde.</td>
                            <td class='tableReqtd'></td>
                            <td class='tableReqtd'></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td class='tableReqtd'style='width: 550px;'>Devolución de placas, plaquetas. Cualquiera que fuera la condición de las mismas (en caso de que no cuente con las placas, deberá presentar Certificación de Reposición de Placas de Vehículo Automotor Terrestre).</td>
                            <td class='tableReqtd'></td>
                            <td class='tableReqtd'></td>
                        </tr>
                        <tr>
                            <td class='tableReqtd'style='width: 550px;'>Resolución emitida por la Dirección Nacional de Tránsito, Transporte y Seguridad Vial en el caso de obsolescencia (original).</td>
                            <td class='tableReqtd'></td>
                            <td class='tableReqtd'></td>
                        </tr>
                    </table>
