        ...
        $documento .= "
            ...
            <div style='margin:30px 55px 55px 55px;'>
                ...
                <div style='text-align: right; margin-bottom: 20px;'>
                    <span style='text-decoration:underline;'><b>REF.: SOLICITUD DEL TRAMITE DE BAJA CON DEUDA DE ACTIVIDADES ECONÓMICAS CON REGISTRO TRIBUTARIO Nº $num_act_</b></span>
                </div>
                <div style='text-align: justify;'>
                    <p>De mi mayor consideración:</p> 
                    <p>Por medio de la presenta nota, me dirijo a su autoridad solicitando el inicio de trámite de BAJA CON DEUDA $txtPlural:
                    </p>
                    $detalleActividad
                    ...
                    <table class='tableReq' align='center'>
                        ...
                        <tr>
                            <td class='tableReqtd' style='width:550px;'>Licencia de funcionamiento vigente</td>
                            <td class='tableReqtd'></td>
                            <td class='tableReqtd'></td>
                        </tr>
                        <tr>
                            <td class='tableReqtd'>Comprobante de pago (PMPAE)</td>
                            <td class='tableReqtd'></td>
                            <td class='tableReqtd'></td>
                        </tr>
                        <tr>
                            <td class='tableReqtd'>Resolución Administrativa (si corresponde)</td>
                            <td class='tableReqtd'></td>
                            <td class='tableReqtd'></td>
                        </tr>
                        <tr>
                            <td class='tableReqtd'>Proforma de liquidación</td>
                            <td class='tableReqtd'></td>
                            <td class='tableReqtd'></td>
                        </tr>
                        <tr>
                            <td class='tableReqtd'>Testimonio de constitución o documento de creación.</td>
                            <td class='tableReqtd'></td>
                            <td class='tableReqtd'></td>
                        </tr>
                        <tr>
                            <td class='tableReqtd'>NIT (Si corresponde)</td>
                            <td class='tableReqtd'></td>
                            <td class='tableReqtd'></td>
                        </tr>
                        <tr>
                            <td class='tableReqtd' style='width:550px;' >Poder Original o Poder legalizado (donde especifique el trámite a realizar en la Dirección de Administración Tributaria Municipal)</td>
                            <td class='tableReqtd'></td>
                            <td class='tableReqtd'></td>
                        </tr>
                        <tr>
                            <td class='tableReqtd'>Fotocopia simple de cédula de identidad (vigentes)</td>
                            <td class='tableReqtd'></td>
                            <td class='tableReqtd'></td>
                        </tr>
                    </table>
